...
*v1.2 | April 7, 2026 | Comprehensive research summary for external review and critique*
...
**Update (April 7, 2026):** Edie Hunt's feedback narrows the company-side thesis. The time investment of deep discovery is only justified for high-stakes hires ($300K+/board-level) where a mis-hire is catastrophic and search fees already run $50K-100K. For volume hiring, speed wins over depth. Two tractable company-side entry points:

1. **Executive recruiter channel:** Recruiters placing senior candidates are the natural buyer. They're already paid for quality, and the lens gives them a structured competitive advantage over other recruiters. Beth Stewart intro pending as first validation.
...
### Phase 4: Company Side (Months 4-8) — NARROWED
With candidate lenses in circulation and coach quality demonstrated, approach companies through Todd's network. Pitch: pre-profiled candidates whose compatibility is already scored. Offer free role lens creation for design partners. **Update (April 7, 2026):** Edie Hunt's feedback narrows the enterprise thesis. Deep discovery is justified at **$300K+/board-level hires** only — volume hiring still prioritizes speed. Two entry paths now in focus:

- **Executive recruiter channel (new):** Exec recruiters placing senior candidates ($300K+) are the natural buyer for depth-over-speed matching. Beth Stewart intro pending as first validation. Narrower but higher-margin than broad enterprise sales.
- **Internal mobility:** Employees are intrinsically motivated (reducing retention loss), the person is already known, and the cost of a bad internal move is felt immediately. Aptitude Research data (77% lost talent, 70% investing more, only 25% confident) validates the pain point. Gloat/Fuel50/Eightfold serve this market on skills only — no identity layer.
...
14. **Enterprise thesis partially validated — but narrower than assumed.** James Pratt (3/30/26) challenged the assumption that companies want precision over volume. **Edie Hunt (4/7/26, retired Goldman Sachs partner, COO HCM, Chief Diversity Officer)** confirmed the risk: deep discovery is only justified for **$300K+/board-level hires** where a mis-hire is catastrophic. For volume hiring, speed wins. She identified **executive recruiters** — not HR, not coaches — as the likely buyer, since they're the ones placing high-stakes candidates where fit-at-depth matters. She also flagged the coach market as too diffuse for volume distribution. Offered intro to Beth Stewart (exec recruiter placing women on corporate boards) as a validation channel. **Implication:** The enterprise wedge is real but narrower and higher-end than the original thesis assumed. Internal mobility (where the person is already known and the cost of a bad internal move is retention loss) may be more tractable than external hiring at scale. **Still to validate with Anne/Rob Birdsong.**
...
16. **Product center of gravity shifting toward consumer-first.** James Pratt's feedback, tester discussions (Brendan, Graham, Luis), and now Edie Hunt's validation signal (4/7/26) are collectively pulling the product toward consumer-first, self-directed use. Edie confirmed that the enterprise wedge is narrower (exec-level hires only) and the coach market is too diffuse for volume distribution. The question is whether to lead with the consumer tool (strongest evidence, broadest adoption) and let enterprise follow through targeted channels (exec recruiters, internal mobility), or continue developing both tracks in parallel.
...
3. **"Companies will pay for role lenses."** At $2,500 per role, this is a premium product. What's the evidence that companies will pay for structured self-assessment when they can post a job description for free? **Edie Hunt signal (4/7/26):** The time investment is only justified for $300K+/board-level hires. At that level, $2,500 is trivial relative to search fees ($50K-100K). Below that level, speed wins. The buyer may be the exec recruiter, not the company directly.
...
*v1.2 updated April 7, 2026. Original produced March 2026. Incorporates primary competitive research, product design work, financial modeling, tester feedback (Brendan McCarthy, Graham, Luis Sampaio), James Pratt strategic feedback (3/30/26), Edie Hunt hiring-leader validation (4/7/26), and honest gap analysis. Provisional patent filed App #64/015,187. It is intended for critical review, not advocacy.*
