...
### Academic Research Advisor Outreach (sent 4/26/26)

- **John Mathieu** (john.mathieu@uconn.edu) — Board of Trustees Distinguished Professor, Friar Chair in Leadership & Teams, UConn School of Business; affiliated I/O Psych faculty. Triple Fellow (SIOP, APA, AoM). Cold email sent 4/26 with hook on his 2022 *JAP* Monograph on CATA for indexing dynamic collective constructs. Target role: NSF SBIR Phase I research advisor for study design and predictive-validity measurement. Awaiting response (window: 7–10 days). Tracked: Airtable Meetings `recOUuBBq7sLRUswq`.
- **Emilija Djurdjevic** (edjurdjevic@uri.edu) — Associate Professor of Management, URI College of Business. Active publishing on construct clarity, scale validation, person-centered methods, common method variance, recruitment. Cold email sent 4/26 with hook on her 2012 *JAP* paper on improving construct clarity for higher-order multidimensional constructs. Target role: RI Innovation Voucher partner AND potentially primary in-state research collaborator for SBIR Phase I (51%-in-RI commitment, see Grant Funding Strategy below). Awaiting response. Tracked: Airtable Meetings `recfpbehu7N4ygiBS`.
- **Vicki Magley** (vicki.magley@uconn.edu) — UConn I/O Program Director. Fallback gateway contact if Mathieu silent by 5/6/26. Research focus is workplace harassment/incivility (not Lens-relevant), but as I/O Director she routes inquiries.
- **Steve Rumery** (UConn IPAC Director / LRI Director) — REMOVED from outreach list. Dual role: at UConn IPAC and at Leadership Research Institute, where he administers the Leadership Role Analyzer. LRI/LRA is adjacent commercial competition (see Competitive Research). Conflict-of-interest precludes cold outreach.
- **Bertram Malle** (Brown CoPsy) — operational consultation only. Has prior $50K RI Innovation Voucher experience (Sproutel, 2017–2019). Not a partnership target (research focus is robotics/HRI, weak topical fit) but useful for Voucher-mechanics consultation if needed.
...
**Competitive Landscape** (`specs/lens-competitive-landscape.md`) — 19 entries in Airtable (LRA added 4/26/26). MD file is source of truth for narrative analysis, risks, GTM strategy, and research citations. Includes SquarePeg cautionary tale, Pymetrics/Harver acquisition, BetterUp current state, internal mobility platform landscape (Gloat, Fuel50, Eightfold AI), Recruiterflow, Plum, Torre.ai, LRI/LRA.
...
- 10 claims (3 independent). **Prior art memo for attorney before conversion must include:** Microsoft Patent US20250378320A1 (generative agent guided conversations for artifact completion), Textkernel bimetric scoring, and **LRI's Leadership Role Analyzer (LRA)** (added 4/26/26).

**NSF SBIR Project Pitch** (`docs/nsf-project-pitch-draft-v1.md`) — v1.3. Research question: does AI-facilitated structured identity discovery produce professional representations with higher predictive validity than self-report methods? Grounded in Oh, Wang, and Mount (2011). Section 4 references UConn I/O concentration (corrected from v1.0/v1.1 URI/Brown CLPS). Submission paused per NSF 4/16/26 alert; expected reopen July 2026.
...
- **Leadership Research Institute (LRI) — Leadership Role Analyzer (LRA)** (added 4/26/26) — Global executive consulting firm. LRA is multi-rater stakeholder process for defining leadership role requirements on five O*NET-derived dimensions (work activities, knowledge areas, skills, abilities, work styles). Closest commercial prior art for the Role Lens specifically — closer than PI (candidate-side) or Plum (matching software). Methodological distinction is real: LRA uses task/skill/competency dimensions and survey methodology; Lens uses identity/values/culture dimensions and AI-facilitated conversational extraction. LRI is unlikely to pivot to AI-facilitated discovery (delivery model and pricing depend on consultant-led engagement). Foil: *"LRA tells you what tasks the role does; Lens tells you who the role needs to be in relationship with."* Tier 2, Threat Level Medium. Steve Rumery (UConn IPAC Director) is also LRI Director administering LRA — explains why he's removed from advisor outreach.
...
- **Competitive Intelligence** (tbl1n2MWWpmlJqhmf) — 19+ records (LRA added 4/26/26)
...
**Mathieu et al. (2022) — closest methodological precedent for Phase I validation strategy.** *Journal of Applied Psychology* 107:4 Monograph. "Indexing Dynamic Collective Constructs Using Computer-Aided Text Analysis: Construct Validity Evidence and Illustrations Featuring Team Processes." Triple-validation strategy (expert hand-coded transcripts, expert observer ratings of video, criterion-related performance prediction) is the recipe Lens needs at the individual identity level. Technical extraction differs (Mathieu uses dictionary-based CATA; Lens uses LLM-based extraction); architectural logic transfers.

**Djurdjevic, Rosen, Johnson, Chang, Taing (2012) — closest precedent for handling higher-order multidimensional constructs.** *Journal of Applied Psychology* 97:1, 62–72. "Recommendations for improving the construct clarity of higher-order multidimensional constructs." Each Lens dimension is itself a higher-order construct composed of multiple indicator signals; this paper's recommendations on confounded indicators, inadequately defined breadth, and common method variance directly apply.
...
- **Eric resides in Providence, RI.** Single-founder LLC where the only employee resides in RI satisfies RI-residency thresholds for state grant programs (see Grant Funding Strategy).

---

## Grant Funding Strategy (added 4/27/26)

### Active Track: NSF SBIR Phase I

- **NSF SBIR Project Pitch** v1.3 ready (`docs/nsf-project-pitch-draft-v1.md`). Submission paused per NSF 4/16/26 alert; resumption expected July 2026.
- **Phase I award range:** up to $305K.
- **Research advisor outreach in progress:** Mathieu (UConn) cold email sent 4/26 — primary advisor target. Magley (UConn) as fallback gateway by 5/6 if Mathieu silent.

### Parallel Track: RI Innovation Voucher

- **Knowledge Provider Voucher** up to $75K, requires 51%+ of work in RI with a RI knowledge provider (university, hospital, research institution).
- **Partnership outreach in progress:** Djurdjevic (URI) cold email sent 4/26.
- **Current round closes 4/28/26** — too tight for cold-start application. Plan: next round, with Djurdjevic relationship pre-established.
- **Project framing:** content validation of lens dimension schema through expert SME categorization, plus pilot multitrait-multimethod study comparing AI-extracted dimension scores against expert hand-ratings. 6–9 month, $75K-scale project complementary to broader Phase I work.

### Cost-Offset Programs (Tracked in Lens Plan Kanban)

- **IRISBF $3K SBIR application reimbursement** (Lens Plan: `recwcQXQGG6uJW1tR`, P2 — Soon). File after submitting NSF Project Pitch / Phase I full proposal. Reimburses 50% of eligible Phase I prep costs up to $3,000. Eligibility verified — Eric's RI residency satisfies the 51% RI-resident-employee requirement. Statute: RI Gen Laws § 42-64.16-1.
- **Invention Incentives $5K patent reimbursement** (Lens Plan: `recRaNgcplwOtoyI8`, P3 — Later). File at nonprovisional patent conversion (deadline 3/24/27). Eligibility likely satisfied; verify program guidelines closer to filing.

### Phase I Budget Design Constraint: 51%-in-RI Commitment

The IRISBF $3K reimbursement requires certifying that 51%+ of the Phase I research will be conducted in RI. This couples the $3K reimbursement to Phase I budget structure:

- **If Mathieu (UConn) is the sole research advisor**, the 51%-in-RI commitment is harder to honor since UConn-conducted research doesn't count toward RI.
- **If Djurdjevic (URI) engages and the bulk of formal research dollars route through her** (as URI subcontract or paid consulting), the 51% is satisfied and the IRISBF $3K is straightforward.

**Implication: the Djurdjevic outreach is strategically more important than originally framed.** She is potentially both the RI Innovation Voucher partner AND the primary in-state research collaborator for SBIR Phase I. Mathieu's role becomes "senior research advisor" (validation methodology, credibility with NSF reviewers), while Djurdjevic's role becomes "primary in-state research collaborator" (executes the validation work in RI). This is a stronger Phase I team than either alone.

### IP Disclosure Filter for Academic Outreach

Two adjacencies disqualify a faculty contact from Lens-IP-sensitive conversation:

1. **Adjacent commercial product makers** — e.g., LRI/LRA (Rumery's dual role).
2. **Adjacent foundation-model employees** — e.g., Google DeepMind, OpenAI, Mistral, xAI, Meta AI.

Both filters apply to all future academic outreach for Lens validation work.
...
- **Academic outreach IP filter** — disqualify adjacent commercial product makers and adjacent foundation-model employees from Lens-IP-sensitive conversations.
...
- **Run more testers** — single highest-leverage activity strengthening any future grant or partnership outcome. The over-building pattern flag from prior sessions points here.
- **Read Mathieu 2022 paper pp. 535–536 + abstract** — before any potential Mathieu reply call. ~30 min.
- **Read Djurdjevic 2012 construct clarity paper** — before any potential Djurdjevic reply call. ~30 min.
- **Two-paragraph note to patent attorney** — academic outreach disclosure implications + add LRA (and Microsoft US20250378320A1, Textkernel bimetric scoring) to prior-art memo before nonprovisional conversion.
- **Mathieu response window** — closes 5/6/26. If silent, send Magley as gateway/routing.
- **Djurdjevic response window** — closes 5/6/26. If silent, evaluate Sean Rogers (URI Dean) as gateway framing.
- **Sign up for RI Commerce Innovation Initiatives mailing list** at commerceri.com — be notified when next Innovation Voucher round opens.
- **Role Lens stakeholder intake** — P0 build. Design and build. Primary validation focus.
...
- **Nonprovisional patent conversion** deadline: 3/24/27.
...
- **Phase I budget split between UConn and URI:** If both Mathieu and Djurdjevic engage, what's the clean split that satisfies the 51%-in-RI commitment for IRISBF and gives both academic partners meaningful work?
- **Invention Incentives $5K eligibility:** verify residency rules and what costs are reimbursable (likely USPTO filing fees, attorney fees, prior-art search; verify before March 2027).
