...
stats: 15+ years | 20-person team built | 2 continents | 10 products supported
---

## Essence

Jordan builds the bridge between a product that works and the people who need it to. Across fifteen years and four companies, the pattern is the same: she walks into organizations where the post-sales experience is an afterthought — where customers are left to figure it out on their own, where support is reactive and success is aspirational — and she builds the function that makes the product's promise real.

She is not a maintainer. She doesn't optimize what already exists. She's the person you bring in when there is no playbook, no team, no process — just customers who need help and a product worth helping them use. She creates the conditions where people can flourish, then gets out of the way. The best sign her work is done is when nobody notices the scaffolding anymore.

Her mind moves fast. She gathers input widely but decides quickly, because momentum matters more than perfection in the environments where she does her best work. She has strong opinions and the drive to act on them. Sitting in an organization where problems are visible but unfixable is the thing that drains her most.

## Skills & Experience

Jordan started at Vista Systems, spending five years managing enterprise accounts — learning how large organizations actually adopt technology, which is to say slowly, politically, and with far more human complexity than anyone plans for. From there she moved through field marketing at a healthcare startup, then into early-stage B2B SaaS at TechFlow, where she first discovered what it felt like to build something from nothing.

Meridian Software is where the throughline crystallized. Over ten years, she built the customer support organization from a team of one to twenty people across two continents, supporting a $100M B2B SaaS platform with 1,200 customers globally. She managed a $1.5M annual budget, oversaw 12,000+ cases per year at 92%+ CSAT, led ISO 27001 and SOC-2 compliance implementation, and deployed AI-powered agent assistance tooling. The customer range spanned $15K ARR startups to $1.5M+ ARR enterprises — she's seen the full spectrum of what "customer success" means at different scales.

Her engineering background gives her a rare capability: she can sit in a room with engineering, understand the architecture, and translate it into customer value — most CS leaders can't. She builds systems that keep working after she leaves the room.

## Values

Ownership comes first. Jordan needs to feel like a builder with real authority, not an employee executing someone else's checklist. When she can shape the function — define the processes, hire the team, make the hard calls — she does her best work. When she's handed a playbook and told to run it, she disengages.

Candor is non-negotiable. She needs honesty to flow upward without consequence and feedback to be treated as useful information, not negativity. She's worked in environments where candor was politically expensive — where raising a real problem got you labeled as difficult — and she cannot build anything meaningful under those conditions. She values transparency in compensation discussions, accountability when people leave, and psychological safety in every team setting.

Constructive friction is how she thinks. She doesn't want harmony for its own sake. She wants structured disagreement — thoughtful processes where people can challenge each other's ideas without it becoming personal or chaotic. Reactive chaos creates anxiety. Thoughtful conflict creates better decisions.

She advocates for people as people — customers and team members both. The moment an organization starts treating either group as abstractions on a dashboard, she loses the thread of why she's there.

## Mission & Direction

Jordan is drawn to VC-backed Series A to early Series B companies — thirty to a hundred people, under $75M raised — solving real problems for people who can't wait for better solutions. B2B SaaS serving non-technical business users in healthcare operations, compliance-heavy environments like government services or financial services, or workforce enablement tools where the end users didn't choose the technology but have to live with it every day.

The window she thrives in is specific: post-product-market-fit, pre-established-CS-function. The product works. Customers are paying. But nobody has built the bridge between the product and the people using it. That's the blank canvas where she does her best work — under genuine growth pressure, not theoretical planning.

The users she's most drawn to serving are clinic administrators, caseworkers, field technicians — people who measure success by whether Tuesday sucked less than Monday. Not power users exploring features. People with real jobs and real consequences when software doesn't work.

## Work Style

Jordan has worked remotely for twenty years and it's not a preference — it's how she's wired to be productive. She needs schedule and location control. Her best deep work happens in coffee shops. Her best reactive work happens in short, focused video calls with small groups — under five people, with concrete next steps and forward momentum, not status theater.

She thrives on about a 70/30 split between focused strategic work and reactive problem-solving. Pure strategy without customer contact makes her restless. Pure firefighting without building toward something burns her out. The combination — building frameworks in the morning, coaching a team member through an escalation in the afternoon — is where she produces the most value.

She communicates through thoughtful writing over instant messaging. Constant Slack interruptions fragment her attention in ways that make everything worse. She's at her best when she can think in complete thoughts, respond deliberately, and trust that her team is doing the same.

Dynamic work with visible impact and quick feedback loops keeps her engaged. Environments that demand sustained attention to low-stakes details without clear purpose are where she struggles. This is the engine behind why she's drawn to building things from scratch, where the work is urgent, varied, and matters.

## Non-Negotiables

Companies over 150 employees are out — at that scale, CS becomes a reporting function rather than a building function. Job descriptions that lead with NRR ownership signal she'd be inheriting someone else's scorecard rather than building her own. Companies over $75M in funding are too far past the building stage, unless there's a rebuilder situation, a new product line, or recent CS leadership turnover that reopens the canvas.

Developer tools under fifty people without enterprise motion — meaning $30K+ deals, multiple buying stakeholders, and contract complexity — don't have the post-sales complexity that makes her skillset relevant. Environments where candor is managed or unwelcome are a hard stop; she's been in those rooms and doesn't go back. Pure IC roles without a path to team-building aren't what she's looking for at this stage.

Sub-$120K base salary signals that the organization views customer success as a cost center, not a strategic function. Director-plus title is the minimum — not for ego, but because it signals organizational commitment to the function she's being asked to build. And she pays attention to interview processes: if the team shows no disagreement and compensation discussions are evasive, that tells her everything she needs to know about the culture she'd be walking into.`;
