...
- **Git (this repo):** Product code, scoring config, schemas, scorers, deliverables, strategy docs, review profiles
- **Git (zelman/tidepool):** Agent lens monolith, user files, cross-project context, coach persona skills
